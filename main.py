...
Description:
    ...
    Having said that, at this time, SalesTrax functions as a simple file merger for tabular financial documents. It
...
NOTES regarding PyCharm:
    ...
    intentional. In any case, all 33 warnings and 4 light warning are illegitimate, and attempting to correct them WILL
